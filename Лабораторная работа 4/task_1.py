if __name__ == "__main__":
    class Sport:
        ...
        def necessary_conditions(self) -> str:
            return f'Необходимые условия зависят от типа спорта'
    ...
    class SkiRace(Sport):
        ...
        def __init__(self, name: str, season: str, num_of_people: int):
            super().__init__(name, season, num_of_people)
        ...
        def necessary_conditions(self) -> str:
            return f'Необходимо зимнее время года, а также горные массивы, с оборудованными трассами'
    ...
    class Volleyball(Sport):
        ...
        def necessary_conditions(self) -> str:
            return f'Необходимо 2 команды по 6 человек, а также сетка'
